...
if locale == "deDE" then
    ...
    L["OPT_ONCE_ONLY"]     = "Texte nur beim ersten Entdecken anzeigen"
    L["OPT_RESET_BTN"]     = "Historie zurücksetzen"
    L["OPT_SCALE"]         = "Fenstergröße (Skalierung)"
    L["OPT_NO_TIMER_CLOSE"] = "Popup dauerhaft anzeigen (kein Timer)"
    ...
    L["OPT_ONCE_ONLY"]     = "Only show lore on first discovery"
    L["OPT_RESET_BTN"]     = "Reset history"
    L["OPT_SCALE"]         = "Window scale"
    L["OPT_NO_TIMER_CLOSE"] = "Keep popup open (no timer)"
    L["CONTEXT_LORE_BTN"]  = "IMAGO Lore"
