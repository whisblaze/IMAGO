...
-- === CAT_QUELTHALAS ===
IMAGOdb.npcs.CAT_QUELTHALAS["lor_themar_theron_es_midnight"].name = "Lor'themar Theron [es]"
IMAGOdb.npcs.CAT_QUELTHALAS["lor_themar_theron_es_midnight"].aliases = {}
IMAGOdb.npcs.CAT_QUELTHALAS["lor_themar_theron_es_midnight"].race = "Elfo de sangre"
IMAGOdb.npcs.CAT_QUELTHALAS["lor_themar_theron_es_midnight"].lore = [[
...
IMAGOdb.npcs.CAT_QUELTHALAS["lor_themar_theron_es_midnight"].zones = {"Ciudad de Lunargenta", "Bosque Canción Eterna", "Isla de Quel'Danas", "Harandar"}
IMAGOdb.npcs.CAT_QUELTHALAS["lor_themar_theron_es_midnight"].source = "Karstan"
IMAGOdb.npcs.CAT_QUELTHALAS["lor_themar_theron_es_midnight"].timeline = IMAGOdb.timelines.LORTHEMAR_THERON
-- === CAT_LIGHT ===
