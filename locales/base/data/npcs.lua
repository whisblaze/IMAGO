...
IMAGOdb.npcs.CAT_NEUTRAL["eitrigg"].timeline = {
    {era = "Pre-WC1", text = "Fought for the newly formed Horde against the Draenei."},
    {era = "WC2", text = "Maintained his position as one of the new Warchief Orgrim's most trusted lieutenants. His faith in the Horde crumbled after the battle at Blackrock Mountain against the Alliance. With two of his children dead and the whole Horde's honor stained, Eitrigg deserted and lived as a hermit in Lordaeron, hidden from the humans."},
    {era = "Pre-WC3", text = "Fought Tirion Fordring. Despite having the opportunity to kill him, Eitrigg saved Tirion's life, creating a debt of honor that the paladin would repay by preventing the orc's execution in Stratholme. Eitrigg joined Thrall's new Horde afterwards but continued to view Tirion as his brother."},
    ...
    {era = "Cata", text = "Continued to be Thrall's advisor, and after Garrosh Warsong took the position of Warchief, he continued in the same role. Eitrigg was the one who discovered Magatha Grimtotem's trap against Ciarne Bloodhoof, who was killed by the poison carried by Gorehowl without Garrosh's knowledge. After that, Eitrigg went to the Burning Steppes with his son Ariok to stop the Dark Horde and his former clan Blackrock's invasion of the Redridge Mountains."},
    ...
    {era = "BfA", text = "Helped Merchant Prince Gallywix establish a base in Drustvar. He traveled with the Champion to Alternate Draenor to recruit the Mag'har orcs, who were being defeated by Yrel's Army of the Light. Eitrigg also participated in the Battle for Stromgarde, fighting alongside Lady Liadrin and Rokhan against Danath Trollbane, Turalyon, and Muradin Bronzebeard. During the Horde's revolution, Eitrigg renounced Sylvanas Windrunner, but failed to join Varok's rebellion in time."},
    ...
    {era = "TWW", text = "Eitrigg, acting as an advisor to Geya'rah, leader of the Mag'har, participated in meetings with Thrall and Geya’rah to maintain peace in the Arathi Highlands. He played an active role in uncovering the true enemy of these lands, the Red Dawn, and defeated Marran Trollbane."},
    {era = "Midnight", text = "He was eventually named a member of the Sons of Lothar, and is called upon when they met to discuss the threats facing Azeroth."}
}
